...
def register_builtins(registry) -> None:
    ...
    impls = [
        ...
        OpImpl(op_name="get_unfused_dot_product_attention_class", impl_id="reference.torch", kind=BackendImplKind.REFERENCE, fn=_bind_is_available(backend.get_unfused_dot_product_attention_class, is_avail), vendor=None, priority=50),
        OpImpl(op_name="get_fused_attention_class", impl_id="reference.torch", kind=BackendImplKind.REFERENCE, fn=_bind_is_available(backend.get_fused_attention_class, is_avail), vendor=None, priority=50),
    ]
