...
"""
Correctness tests for normalization functions.

Tests LayerNorm and RMSNorm (forward and backward) across all available backends.
"""
...
class NormalizationTests(TestCase):
    ...
    def _reference_layernorm_forward(self, x, weight, bias, eps):
        """Compute reference LayerNorm forward."""
    ...
    def _reference_rmsnorm_forward(self, x, weight, eps):
        """Compute reference RMSNorm forward."""
    ...
    def test_layernorm_backward(self, shape=(2, 4, 8)):
        ...
        for backend_name in self.backends:
            ...
            try:
                ...
                self.assert_close(
                    grad_bias, ref_grad_bias, rtol=1e-5, atol=1e-7,
